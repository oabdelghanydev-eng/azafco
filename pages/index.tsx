  ...
  const features = [
    {
      ...
      title: locale === 'ar' ? 'مصدر موثوق' : 'Trusted Source',
      description: locale === 'ar'
        ? 'نضمن أن كل سمكة تأتي من مزارع معتمدة ومراقبة.'
        : 'We ensure every fish comes from certified and monitored farms.',
    },
    {
      icon: <FaSnowflake className="text-5xl text-blue-500" />,
      title: locale === 'ar' ? 'سلسلة تبريد مثالية' : 'Perfect Cold Chain',
      description: locale === 'ar'
        ? 'نحافظ على درجة حرارة مثالية من لحظة الصيد حتى التسليم.'
        : 'We maintain optimal temperature from catch to delivery.',
    },
    {
      icon: <FaUserTie className="text-5xl text-secondary-600" />,
      title: locale === 'ar' ? 'مخصصة للمحترفين' : 'For Professionals',
      description: locale === 'ar'
        ? 'نحن نفهم احتياجات المطاعم والموزعين ونقدم أفضل ما يناسبهم.'
        : 'We understand the needs of restaurants and distributors.',
    },
  ]
        ...
        <div className="container-custom relative z-10 py-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              {locale === 'ar' ? companyInfo.name : 'AZAFCO International'}
              <br />
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-gray-200 leading-relaxed">
              {locale === 'ar'
                ...
                : 'A company specialized in packaging and exporting fresh fish to all countries. We serve distributors and restaurants with the highest quality and freshness standards.'}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              >
                <FaFish />
                {locale === 'ar' ? 'تصفح منتجاتنا' : 'Browse Products'}
              </Link>
              <Link
                href="/contact"
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            >
              ...
              <div className="text-lg">{locale === 'ar' ? 'عميل راضي' : 'Satisfied Clients'}</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.5 }}
              whileInView={{ opacity: 1, scale: 1 }}
      ...
      <section className="py-20">
        <div className="container-custom">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="section-title">{locale === 'ar' ? 'أسواقنا' : 'Our Markets'}</h2>
            <p className="section-subtitle">
              {locale === 'ar'
                ? 'نصدر منتجاتنا إلى أفضل الأسواق في المنطقة'
                : 'We export our products to the best markets in the region'}
            </p>
          </motion.div>
